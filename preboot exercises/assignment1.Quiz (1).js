...
let c1 =  'Experimenting, discovering, and learning'
let c2 = 'Helping others'
let c3 = 'Music, movies, games, and making others laugh'
let c4 ='Taking risks'

console.log('What gets you the most excited?')
...
function tabulateAnswers() {
    ...
    if (c5score == maxscore) { // If user chooses the fifth choice the most, this outcome will be displayed.
        answerbox.innerHTML = "You are an horroble coder it is better for you to flip burgers";
      }
  }
